...
func (o Int32) OrElseWithFlag(other int32) (int32, bool) {
	if !o.Present {
		return other, false
	}
...
// and non-nil error.
func (o Int32) OrElseWithErr(other int32) (int32, error) {
	if !o.Present {
...
func (o Int32) OrElseGetWithFlag(supplier func() int32) (result int32, ok bool) {
	if !o.Present {
...
func (o Int32) OrElseGetWithErr(supplier func() int32) (result int32, err error) {
	if !o.Present {
...
func (o Int32) OrElseErr(errSupplier func() error) (result int32, err error) {
	if !o.Present {
		err = errSupplier()
		return
	}
